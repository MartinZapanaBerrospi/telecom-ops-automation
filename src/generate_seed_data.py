...
Todos los datos son ficticios: empresas, personas, documentos y montos fueron
inventados para este ejercicio y no corresponden a clientes reales.
Crea:
...
def generar_datasets():
    ...
    facturas = [
        {"IdFactura": "FAC-1001", "NumeroRecibo": "F001-00045210", "IdCliente": "CLI-801", "ClienteNombre": "Minera Altoandina S.A.C.", "TipoDocumento": "RUC", "NumeroDocumento": "20554896321", "PlanNombre": "Plan Corporativo Móvil Ilimitado 120", "MontoTotal": 450.00, "Ciclo": "C01", "FechaEmision": "2026-08-01", "EstadoPago": "EMITIDO"},
        ...
        {"IdFactura": "FAC-1003", "NumeroRecibo": "F001-00045212", "IdCliente": "CLI-803", "ClienteNombre": "Distribuidora Vista Norte S.A.C.", "TipoDocumento": "RUC", "NumeroDocumento": "20601245897", "PlanNombre": "Plan Negocios Fibra Óptica 200MB", "MontoTotal": 280.00, "Ciclo": "C01", "FechaEmision": "2026-08-01", "EstadoPago": "EMITIDO"},
        ...
        {"IdFactura": "FAC-1005", "NumeroRecibo": "F001-00045214", "IdCliente": "CLI-805", "ClienteNombre": "Constructora Ribera del Norte S.A.C.", "TipoDocumento": "RUC", "NumeroDocumento": "20100458963", "PlanNombre": "Troncal SIP Flota Móvil 50 Líneas", "MontoTotal": 3250.00, "Ciclo": "C15", "FechaEmision": "2026-08-15", "EstadoPago": "EMITIDO"},
        ...
        {"IdFactura": "FAC-1007", "NumeroRecibo": "F001-00045216", "IdCliente": "CLI-807", "ClienteNombre": "Textil Santa Aurora E.I.R.L.", "TipoDocumento": "RUC", "NumeroDocumento": "20489632145", "PlanNombre": "Plan Empresarial Enlace Dedicado", "MontoTotal": 540.00, "Ciclo": "C28", "FechaEmision": "2026-08-28", "EstadoPago": "EMITIDO"},
        ...
        {"IdFactura": "FAC-1009", "NumeroRecibo": "F001-00045218", "IdCliente": "CLI-809", "ClienteNombre": "Corporación Minera Pampa Azul S.A.C.", "TipoDocumento": "RUC", "NumeroDocumento": "20334455667", "PlanNombre": "Plan Telecom Enterprise Voz & Datos Ilimitado", "MontoTotal": 1820.00, "Ciclo": "C28", "FechaEmision": "2026-08-28", "EstadoPago": "EMITIDO"},
    ...
    ajustes = [
        ...
        {"IdAjuste": "AJU-2026-003", "IdFactura": "FAC-1009", "NumeroRecibo": "F001-00045218", "IdCliente": "CLI-809", "ClienteNombre": "Corporación Minera Pampa Azul S.A.C.", "TipoIncidencia": "DESCUENTO_NO_APLICADO", "MontoReclamado": 145.50, "MontoReconocido": 0.00, "EstadoReclamo": "PENDIENTE_JEFATURA", "UsuarioAnalista": "martin.zapana.b@uni.pe", "FechaRegistro": "2026-09-01 09:20:00", "Justificacion": "Convenio corporativo anual con descuento del 8% no imputado en el ciclo."},
